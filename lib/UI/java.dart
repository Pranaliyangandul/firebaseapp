...
class JavaForm extends StatefulWidget {
  @override
  JavaFormState createState() {
    return JavaFormState();
  }
}

// Create a corresponding State class, which holds data related to the form.
class JavaFormState extends State<JavaForm> {
  ...
  javafunc(n, p, d, de, c, y, e) async {
    await FirebaseFirestore.instance.collection('Java').add({
