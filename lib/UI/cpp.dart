...
class CppForm extends StatefulWidget {
  @override
  CppFormState createState() {
    return CppFormState();
  }
}

// Create a corresponding State class, which holds data related to the form.
class CppFormState extends State<CppForm> {
  ...
  cppfunc(n, p, d, de, c, y, e) async {
    await FirebaseFirestore.instance.collection('Cpp').add({
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Text(
                "Design, build, and maintain efficient, reusable, and reliable C++ code.Implement performance and quality modules.Identify bottlenecks and bugs, and devise solutions to these problems.Help maintain code quality, organization, and automatization.",
